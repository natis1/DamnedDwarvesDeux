...
public class ElvenCraft extends ElvenSprite {
	...
	private void initCraft() {
		...
		pixieHelper = new ElvenPixAlly(x - 30, y + 80, angle, "elvenFae.png");


		//Init arrays
		craftShieldsDrawing = new ElvenSpriteParticle(x, y, 4, 0, "elvenForceField.png");
	...
	public void isPressed(){
		...
		if (keySetter.elvenAsciiInput[1]){ //VK UP
			...
			if (generateParticles < 0){
				...
				ElvenSpriteParticles.add(new ElvenSpriteParticle(x + spriteLoc, y + getHeight() - 4, particleSpeed, Math.PI/2, "elvenPixieDustYellow.png"));
		...
		if (keySetter.elvenAsciiInput[2]){ //VK LEFT
			...
			if (generateParticles < 0){
				int spriteLoc = craftRNG.nextInt(35);
				ElvenSpriteParticles.add(new ElvenSpriteParticle(x + getWidth() - 4, y + spriteLoc, particleSpeed, 0, "elvenPixieDustYellow.png"));
				generateParticles = maxGenerateParticles;
			}
		}
		if (keySetter.elvenAsciiInput[3]){ //VK RIGHT
			...
			if (generateParticles < 0){
				int spriteLoc = craftRNG.nextInt(35);
				ElvenSpriteParticles.add(new ElvenSpriteParticle(x, y + spriteLoc, particleSpeed, Math.PI, "elvenPixieDustYellow.png"));
				generateParticles = maxGenerateParticles;
			}
		}
		if (keySetter.elvenAsciiInput[4]){ //VK DOWN
			...
			if (generateParticles < 0){
				int spriteLoc = craftRNG.nextInt(35);
				ElvenSpriteParticles.add(new ElvenSpriteParticle(x + spriteLoc, y + 4, particleSpeed, 3 * Math.PI/2, "elvenPixieDustYellow.png"));
				generateParticles = maxGenerateParticles;
			}
		}
