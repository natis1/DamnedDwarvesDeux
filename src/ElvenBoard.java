...
public class ElvenBoard extends JPanel {
    ...
    private DwarvenAbathur hijackedByDwarves = new DwarvenAbathur();
    ...
    private void initBoard() {
        ...
        if (universalScaler <= 1.0001){
            bgImageString = "background2.png";
            is4K = false;
        } else {
            bgImageString = "background4.png";
    ...
    public void update() {
        ...
        if (!isGameOver){
            ...
            gameData.add(Elvenenemies.get(0).getY() - craft.getY());
            gameData.add(Elvenenemies.get(0).getEnemyHP());
            gameData.add(craft.pixieHelper.fireDelay * (15 - ElvenMain.ElvenUpgradeFirerate) );


            hijackedByDwarves.livingCreature.setGameVariablesAndRun(gameData);
            craft.keySetter.elvenAsciiInput = hijackedByDwarves.livingCreature.keysPressed;
